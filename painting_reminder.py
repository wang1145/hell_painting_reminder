...
def create_cat_clock():
    ...
    # 创建电子钟窗口
    pygame.init()
    clock = pygame.display.set_mode((250, 250))
...
def draw_cat_clock(screen):
    """绘制猫形电子钟"""
    # 清屏
    screen.fill((255, 240, 240))  # 浅粉色背景

    # 绘制猫脸
    pygame.draw.circle(screen, (240, 200, 180), (125, 100), 80)  # 猫脸

    # 绘制猫耳朵
    pygame.draw.polygon(screen, (240, 200, 180), [(85, 40), (65, 20), (105, 30)])  # 左耳
    pygame.draw.polygon(screen, (240, 200, 180), [(165, 40), (185, 20), (145, 30)])  # 右耳

    # 绘制猫眼睛
    pygame.draw.circle(screen, (80, 80, 160), (95, 90), 15)  # 左眼
    pygame.draw.circle(screen, (80, 80, 160), (155, 90), 15)  # 右眼
    pygame.draw.circle(screen, (0, 0, 0), (95, 90), 7)  # 左眼珠
    pygame.draw.circle(screen, (0, 0, 0), (155, 90), 7)  # 右眼珠

    # 绘制猫鼻子
    pygame.draw.polygon(screen, (255, 150, 150), [(125, 110), (115, 120), (135, 120)])  # 鼻子

    # 绘制猫嘴
    pygame.draw.arc(screen, (0, 0, 0), (110, 120, 30, 30), 0, 3.14, 2)  # 微笑

    # 绘制猫胡须
    pygame.draw.line(screen, (0, 0, 0), (85, 110), (55, 100), 1)  # 左上
    pygame.draw.line(screen, (0, 0, 0), (85, 120), (55, 120), 1)  # 左中
    pygame.draw.line(screen, (0, 0, 0), (85, 130), (55, 140), 1)  # 左下
    pygame.draw.line(screen, (0, 0, 0), (165, 110), (195, 100), 1)  # 右上
    pygame.draw.line(screen, (0, 0, 0), (165, 120), (195, 120), 1)  # 右中
    pygame.draw.line(screen, (0, 0, 0), (165, 130), (195, 140), 1)  # 右下

    # 获取当前北京时间
    beijing_time = time.strftime("%Y:%m:%d:%H:%M")

    # 绘制时间显示
    font_large = pygame.font.SysFont('simhei', 28)
    time_text = font_large.render(beijing_time, True, (80, 30, 30))
    screen.blit(time_text, (125 - time_text.get_width() // 2, 170))
...
def show_hell_reminder():
    ...
    # 显示弹窗10秒
    start_t = time.time()
    while time.time() - start_t < 10 and is_active:
...
def main():
    global timer_thread, last_clock_update, clock_window
    ...
    while True:
        ...
        # 每15秒更新一次电子钟
        if current_time - last_clock_update > 15:
            draw_cat_clock(clock_window)
...
if __name__ == "__main__":
    # 首次启动显示地狱欢迎语
    print("╔══════════════════════════════════════════════════╗")
    print("║          地狱绘画时间提醒器 v1.1.2 已启动         ║")
    print("║  新增功能：猫形电子钟（15秒刷新一次）            ║")
